        ...
        <section className="mx-auto flex max-w-[1440px] flex-col justify-center px-4 py-20 lg:h-[800px] lg:px-[120px] lg:py-[60px]">
            ...
            <div className="mt-16 grid w-full grid-cols-1 gap-[32px] md:grid-cols-3">
                {strategyItems.map((item) => (
                    <div key={item.alt} className="group flex h-[400px] w-full flex-col items-center justify-center gap-[32px] rounded-[8px] border border-[#41bdc7] bg-transparent px-4 py-[42px] transition-all hover:bg-white/5 lg:px-[64px]">
